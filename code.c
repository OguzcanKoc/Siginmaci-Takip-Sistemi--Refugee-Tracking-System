...
void dosya_S_OKU();			//Dosyada Siginmacilari kay�tlar�n diziye okur
void dosya_M_OKU();			//Dosyada Kullan�c� kay�tlar�n diziye okur
void dosya_S_ARAMA();
void dosya_M_ARAMA();
void menu_S_Arama();
void menu_M_Arama();
...
//Dosyada siginmacilari kay�tlar�n diziye okur
void dosya_S_OKU() {
	FILE *di;
	unsigned int tane;
	int i, k;
...
//Dosyada Kullan�c� kay�tlar�n diziye okur
void dosya_M_OKU() {
	FILE *di;
	//unsigned int tane;
	int i, k;
